...
Revision ID: 011_email_digest_reminders
...
revision: str = "011_email_digest_reminders"
...
def upgrade() -> None:
    # Alembic creates this column as VARCHAR(32), while this historical
    # revision identifier is longer. Widen it before Alembic records the
