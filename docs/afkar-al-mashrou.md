...
> **توثيق MCP:** [`MCP/Documentation.md`](../MCP/Documentation.md) — التصميم، ما تم إنجازه، وخارطة التنفيذ.
...
| ٢٣/٠٨/٢٠٢٦ | نقل توثيق MCP بالكامل إلى [`MCP/Documentation.md`](../MCP/Documentation.md) |
