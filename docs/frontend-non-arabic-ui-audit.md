...
عولجت النقاط ذات الأولوية بعد التدقيق:

- عُرّبت واجهات Clerk المدمجة، وأصبحت الرسائل غير المعروفة تستخدم بدائل عربية آمنة.
- مُنع تمرير تفاصيل API غير العربية إلى المستخدم، مع الإبقاء على رسائل الخادم العربية.
- عُرّب زرا `See JSON`، وعنصر اختيار صور البلاغ، وبدائل الأدوار والحالات غير المعروفة.
- استُبدلت صيغة الإصدار `v2` بصيغة عربية مثل `الإصدار ٢`.

تبقى الأقسام التالية سجلًا لنتائج التدقيق الأصلية وسياق القرارات.
