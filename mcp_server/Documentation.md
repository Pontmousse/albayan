...
تبقى مسودات المراجعة وإدارة الأصول عبر MCP قدرات مستقبلية. ملف PDF الحالي
...
المقال، أو أي mutation عالية الأثر. عرض PDF الحالي متاح فقط عبر المسار
المصادق المرتبط بمراجعة الجلسة؛ عرض الأصول نفسها وروابطها يبقى مؤجلاً.
