...
export const MAPPING_FONTS: readonly MappingFontConfig[] = [
  {
    id: "default",
    labelAr: "الافتراضي",
    descriptionAr: "النص العربي المعتاد داخل المعادلة.",
    latexCommand: null,
    mode: "text",
  },
  {
    id: "takween",
    labelAr: "تكوين",
    descriptionAr: "عرض القيمة بخط تكوين.",
  ...
  },
  {
    id: "diwani",
    labelAr: "ديواني",
    descriptionAr: "عرض القيمة بالخط الديواني.",
  ...
  },
  {
    ...
    descriptionAr: "عرض ديواني بإطار زخرفي.",
  ...
  },
  {
    id: "maghribi",
    labelAr: "مغربي",
    descriptionAr: "عرض القيمة بالخط المغربي.",
  ...
  },
  {
    id: "none",
    labelAr: "بدون تغليف",
    descriptionAr: "يحفظ القيمة كما كُتبت؛ خيار خاص للحالات المتقدمة.",
    latexCommand: null,
    mode: "raw",
  },
] as const;
