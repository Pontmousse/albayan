...
/** قيم جاهزة للنسخ عند إنشاء موصل ChatGPT */
...
export type ChatGptDetailedStep = {
  text: string;
...
export type ChatGptDetailedSection = {
  title: string;
  steps: ChatGptDetailedStep[];
};

export const CHATGPT_DETAILED_GUIDE: ChatGptDetailedSection[] = [
  {
