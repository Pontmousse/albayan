    ...
    <div className="flex flex-1 flex-col bg-[var(--journal-paper)]">
      <main className="mx-auto w-full max-w-3xl flex-1 px-4 py-10 sm:px-6 lg:py-14">
        ...
        <p className="mt-4 text-pretty text-sm leading-7 text-slate-600 sm:text-base">
          اختر برنامجك واربطه بخادم البيان البعيد، ثم سجّل دخولك ووافق على
          الوصول. لا تحتاج إلى مفتاح شخصي أو عنوان واجهة API. الوكيل يساعدك في
          القراءة والكتابة والمراجعة، بينما الحفظ والتقديم والقرارات النهائية تبقى
          من منصة البيان.
        </p>
