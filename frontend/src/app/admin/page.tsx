...
export default function AdminPage() {
  ...
  if (!isLoaded) {
    return (
      <main className="mx-auto flex w-full max-w-3xl flex-1 items-center justify-center px-6 py-16">
        <p className="text-sm text-slate-500">جار التحقق من الصلاحيات...</p>
      </main>
    );
  }
  ...
  return (
    <main className="mx-auto flex w-full max-w-3xl flex-1 flex-col justify-center gap-4 px-6 py-16 text-center">
      <p className="text-sm font-semibold tracking-wide text-[var(--journal-accent)]">
        Admin
      </p>
      <h1 className="text-3xl font-bold text-slate-900">لوحة الإدارة</h1>
      <p className="text-base text-slate-600">
        هذه صفحة تجريبية بسيطة للتأكد من أن دور المدير من Clerk يعمل كما هو متوقع.
      </p>
    </main>
  );
}
