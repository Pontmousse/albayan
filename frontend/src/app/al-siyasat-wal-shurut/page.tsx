        ...
        <div className="mt-10 space-y-12 text-slate-800">
          ...
          <section id="privacy">
            ...
            <div className="mt-4 space-y-3 text-sm leading-7">
              ...
              <p>
                عند استخدام وكيل متصل عبر MCP، نحتفظ لمدة لا تتجاوز 90 يوماً بسجل
                إداري منقّح لاسم الأداة والأمر وحالته ومدته ولقطات محدودة من المدخلات
                والمخرجات. تُحجب بيانات الاعتماد ولا تُحفظ ترويسات الطلب، ولا يطّلع
                على هذه السجلات إلا مديرو المنصة لأغراض التشغيل والأمان وتحسين الخدمة.
              </p>
              <p>
