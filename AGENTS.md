...
- رسائل أمان الحساب التي يملكها Clerk تتبع `docs/clerk-security-email-templates.md`: مالك إرسال واحد لكل حدث، مع بقاء رسائل الأمان العادية لدى Clerk واعتراض البيان فقط لعائلتي OTP المعتمدتين (التحقق من البريد واستعادة كلمة المرور).
